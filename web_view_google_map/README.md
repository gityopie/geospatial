...
There are five available attributes that you can customize
 ...
 - `mode` : an attribute to tell map which map that will be loaded (default: `geometry`).
...
```xml
    ...
    <record id="view_res_partner_map" model="ir.ui.view">
        ...
        <field name="arch" type="xml">
            <map class="o_res_partner_map" mode='geometry' string="Map" lat="partner_latitude" lng="partner_longitude" colors="blue:company_type=='person';green:company_type=='company';">
                <field name="id"/>
...
*We recommend you to setup __Google Maps Key API__ and add it into Odoo `Settings > General` Settings when you installed this module*
